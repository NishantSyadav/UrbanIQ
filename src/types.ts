// Types and Seed Data for UrbanIQ
...
export interface AICivicAnalysis {
  ...
  aiConfidence: number;
  citizenSafetyGuidelines: string[];
  requiredEquipment: string[];
  aiAutoKeywords: string[];
}

export interface Comment {
  id: string;
  userName: string;
  userRole: 'Citizen' | 'Dispatcher' | 'Field Engineer' | 'AI Auditor';
  text: string;
  timestamp: string;
}
...
export interface CivicIssue {
  ...
  aiAnalysis?: AICivicAnalysis;
  comments: Comment[];
  updates: UpdateState[];
  
  // New Authority Management properties
  assignedDepartment?: string;
  assignedOfficer?: string;
  inspectionDate?: string;
  progressRemarks?: string;

  // Video and Media Support properties
...
// Highly detailed seed data spanning standard municipal problems
